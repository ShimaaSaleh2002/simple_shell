...
/**
 * free_args -> it Frees up memory taken by args.
 * @args: A null- is a terminated double pointer containing commands/arguments.
...
/**
 * get_pid -> it Gets the current process ID.
...
/**
 * get_env_value -> it Gets the value corresponding to an environmental variable.
 * @beginning: environmental variable to search for.
 * @len: length of the environmental variable to search for.
 *
 * Return: when variable not found - an empty string.
...
/**
 * variable_replacement -> it Handles variable replacement.
