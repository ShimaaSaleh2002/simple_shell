...
/**
 * add_alias_end - Methood Adds a node to the end of a alias_t linked list.
...
/**
 * free_alias_list - Method to Frees a alias_t linked list.
...
/**
 * free_list - Method to Frees a list_t linked list.
